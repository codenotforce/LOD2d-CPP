...
/// Estimate the number of elements cut by the first conforming NVB closure
/// generated by each candidate element independently.  The edge-incidence
/// graph is assembled once for the whole batch, making this suitable for a
/// closure-cost-aware marking shortlist.  Values are topology costs, not a
/// promise about the marginal cost after other marks have been selected.
